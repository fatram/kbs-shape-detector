...
class Application(Frame):
    ...
    def get_image_file(self):
        ...
        if file != None:
            ...
            self.analyzer._detect_corner()
            self.analyzer._find_suduts()
            self.analyzer._find_vertices()
    ...
    def create_widgets(self):
        ...
        self.panel1 = Label(framet, image=None,text="No image selected", bg='white')
        self.panel1.pack()
        ...
        self.panel2 = Label(framet2,text="No image selected",image=None, bg="white")
        self.panel2.pack()
